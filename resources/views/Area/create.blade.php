...
<div class="p-3 mb-2 bg-primary bg-gradient fw-bold text-white">Nueva Area</div>

                        {!! Form::open(['url'=>'/areas','style'=>'color:black;','id'=>'main-contact-form','class'=>'row g-3 needs-validation','name'=>'contact-form'])!!}
                        <div class="col-md-4">
    ...
    {!! Form::text ('nombre',null,['placeholder'=>'Ingresa nombre ','class'=>'form-control' ,'required','onkeyup'=>'validaciones();'])!!}
                        ...
                        <div class="col-md-4">
                            ...
                            {!! Form::select ('id_sucursal',array('1'=>'Pilot Chemical'),null,['placeholder'=>'Seleccionar','class'=>'form-control','required','onkeyup'=>'validaciones();'])!!}
